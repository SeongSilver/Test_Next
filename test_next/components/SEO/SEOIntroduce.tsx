    ...
    <SliderContainer>
      ...
      <div className="slider text-center">
        <div>
          ...
          <br />
          <p>
            검색 사용자의 검색 의도에 맞게 검색엔진을 최적화 하여
            <br />
            검색엔진의 평가를 높여 페이지 노출을 높이고
            <br />
      ...
      <div className="slider">
        ...
        <div className="text-center">
          <p className="my-12">
            1. 30%의 사용자들은 첫 번째 검색 결과를 클릭한다
            <br />
            <br /> → 검색결과 상단에 올리는 것이 중요하다
          </p>
          <p className="my-12">
            2. 검색 결과 첫번째 페이지 안에 들지 못하면 사실상 사람들에게 거의
            노출되지 못한다
            <br />
            <br />
            → 검색 결과에서 대부분 첫번째 페이지 혹은 한 번의 스크롤로 끝내는
            사람이 많다
            <br />
            (단 9%만이 스크롤을 내리고, 15%만이 원하는 다른 키워드를 이용하여
            검색을 한다고함)
          </p>
          <p>
            3. 홈페이지의 디자인이 별로여도 검색 결과 상위권에 노출되는 아무
            문제가 없다
            <br />
            <br />→ 디자인보다 SEO가 더 중요하지만, 홈페이지 내용이 부실하면
            유입 후 이탈률이 높아진다
          </p>
        ...
        <div className="flex justify-center">
          <div className="w-[30%] h-[50vh] bg-slate-50 m-4 p-8 rounded-[20px]">
            ...
            <ul>
              ...
              <li>
                - 엔진이 웹 페이지를 인덱싱하고 검색 결과를 제공하는데 사용
              </li>
            </ul>
          </div>
          <div className="w-[30%] h-[50vh] bg-slate-50 m-4 p-8 rounded-[20px]">
            ...
            <ul>
              ...
              <li>
                - 검색 엔진은 크롤링을 통해 수집한 웹 페이지를 분석하여 적절한
                색인 구조를 만듦
              </li>
              <li>
                - 검색 의도에 맞춰 색인된 콘텐츠에 순위를 부여한 결과로 제공
              </li>
            </ul>
          </div>
          <div className="w-[30%] h-[50vh] bg-slate-50 m-4 p-8 rounded-[20px]">
            ...
            <p>
              HTML 문서의 head 부분에 위치
              <br /> 문서의 데이터를 정의하는 태그
            </p>
            <br />
            <ul>
              <li>
                - 문서의 정보를 설명하는 데이터(제목, 작성자, 키워드, 설명 등)
              </li>
              <li>
                - 검색 엔진이 웹 페이지를 색인할 떄, 페이지의 내용을 이해하고
                검색 결과에 표시하는데에도 사용
              </li>
              <li>
                - 페이지의 키워드와 설명을 정의하는 메타 태그는 검색 엔진이
                페이지를 분석하는데 도움을 줌
              </li>
            </ul>
          </div>
